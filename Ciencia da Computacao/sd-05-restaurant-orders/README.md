...
## Data de Entrega
  ...
  - Data de entrega para avaliação final do projeto: `26/04/2021 - 14:00h`.
...
- `git clone git@github.com:tryber/sd-05-restaurant-orders.git`.
- Entre na pasta do repositório que você acabou de clonar:
  - `sd-05-restaurant-orders`
...
- Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-05-restaurant-orders/pulls)
